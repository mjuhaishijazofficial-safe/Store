...
export const dict = {
  ...
  'privacy.s6Title': { ur: 'Eagle Voice Assistant', en: 'Eagle Voice Assistant' },
  'privacy.s6Body': { ur: 'Jab aap mic button dabate hain, aapki awaz OpenAI (Whisper/GPT) ko sirf us waqt bheji jati hai jab aap bol rahe hon — text mein badalne aur samajhne ke liye. Recording kabhi save nahi hoti, sirf us ek command ke liye use hoti hai aur foran discard ho jati hai. Kuch general sawalon ke liye Google (Gemini) se live jawab liya ja sakta hai. Eagle Settings se kabhi bhi band kiya ja sakta hai.', en: 'When you tap the mic button, your voice is sent to OpenAI (Whisper/GPT) only while you are speaking — to convert it to text and understand it. Nothing is ever saved; each recording is used for that one command and immediately discarded. Some general questions may be answered live via Google (Gemini). Eagle can be turned off entirely from Settings.' },
  ...
  'voice.searchingFor': { ur: '"{name}" dhoond raha hoon...', en: 'Looking for "{name}"...' },
  'voice.searchingAnswer': { ur: 'Jawab dhoond raha hoon...', en: 'Finding an answer...' },
  'voice.saving': { ur: 'Save kar raha hoon...', en: 'Saving...' },
  'voice.cancel': { ur: 'Cancel', en: 'Cancel' },
  ...
  'voice.summaryAddCustomer': { ur: 'Naya customer banayein: {name} (phone: {phone})', en: 'Create new customer: {name} (phone: {phone})' },
  'voice.answerCustomerExists': { ur: '{name} pehle se khata mein mojood hai', en: '{name} is already in your khata' },
  'voice.answerBalanceOwes': { ur: '{customer} ka udhaar {amount} hai', en: '{customer} owes {amount}' },
  'voice.answerBalanceAdvance': { ur: '{customer} ka {amount} advance jama hai', en: '{customer} has {amount} in advance' },
  'voice.answerBalanceClear': { ur: '{customer} ka hisaab saaf hai', en: '{customer} has a clear balance' },
  ...
  'voice.errSupplierNotFound': { ur: '"{name}" naam ka supplier nahi mila', en: 'No supplier found named "{name}"' },
  'voice.errNoAccess': { ur: 'Aapko is section ki access nahi hai', en: 'You don\'t have access to this section' },
  'voice.errNoQty': { ur: 'Quantity samajh nahi aayi', en: 'Couldn\'t work out the quantity' },
  'voice.summaryStockIn': { ur: 'Stock In: {item} — {qty} {unit}', en: 'Stock In: {item} — {qty} {unit}' },
  'voice.summaryStockOut': { ur: 'Stock Out: {item} — {qty} {unit}', en: 'Stock Out: {item} — {qty} {unit}' },
  'voice.summaryAddExpense': { ur: 'Expense add karein: {category} — {amount}', en: 'Add expense: {category} — {amount}' },
  'voice.summarySupplierPayment': { ur: '{supplier} ko diya: {amount}', en: 'Pay {supplier}: {amount}' },
  'voice.answerExpenseTotal': { ur: 'Aaj ka total expense {amount} hai', en: 'Today\'s total expenses are {amount}' },
  'voice.answerSalesTotal': { ur: 'Aaj ki total sale {amount} hai', en: 'Today\'s total sales are {amount}' },
  'voice.answerSupplierOwes': { ur: '{supplier} ka {amount} dena hai', en: 'You owe {supplier} {amount}' },
  'voice.answerSupplierClear': { ur: '{supplier} ka hisaab saaf hai', en: '{supplier}\'s balance is clear' },
  'voice.doneCustomerAdded': { ur: 'Customer add ho gaya ✓', en: 'Customer added ✓' },
  'voice.summaryUpdatePhone': { ur: '{name} ka number update karein: {phone}', en: 'Update {name}\'s number: {phone}' },
  'voice.donePhoneUpdated': { ur: 'Number update ho gaya ✓', en: 'Number updated ✓' },
  'voice.answerInventorySummary': { ur: 'Total {total} items hain, {low} low stock mein, {out} khatam ho chuke.', en: '{total} items in total, {low} low on stock, {out} completely out.' },
  'voice.answerOutOfStockNames': { ur: 'Khatam: {names}.', en: 'Out: {names}.' },
  'voice.answerLowStockNames': { ur: 'Kam: {names}.', en: 'Low: {names}.' },
  'voice.doneOpeningStatement': { ur: '{name} ka statement khol raha hoon...', en: 'Opening {name}\'s statement...' },
  'voice.errNoPhone': { ur: '{name} ka koi phone number nahi mila — number bolein', en: 'No phone number found for {name} — please say a number' },
  'voice.summarySendWhatsapp': { ur: '{name} ko WhatsApp par bhejein: {phone}', en: 'Send to {name} on WhatsApp: {phone}' },
  'voice.whatsappStatementMsg': { ur: '{customer}, aapka khata: {balanceLine} — {shop}', en: '{customer}, your account: {balanceLine} — {shop}' },
  'voice.doneWhatsappOpened': { ur: 'WhatsApp khul gaya — ab "Send" dabayein', en: 'WhatsApp opened — now tap "Send"' },
  'voice.doneConfirmedSuffix': { ur: '— ho gaya ✓', en: '— done ✓' },
  'voice.clarifyPrompt': { ur: 'Kaunsa? {names}', en: 'Which one? {names}' },
  'voice.clarifyOr': { ur: ' ya ', en: ' or ' },
  'voice.clarifyTitle': { ur: 'Kaunsa?', en: 'Which one?' },
  'voice.handsFreeToggle': { ur: 'Bina hath lagaye — "Eagle" bol kar activate karein', en: 'Hands-free — say "Eagle" to activate' },
  'voice.handsFreeOn': { ur: 'Hands-free ON', en: 'Hands-free ON' },
  'voice.handsFreeOff': { ur: 'Hands-free OFF', en: 'Hands-free OFF' },
  'voice.waitingForWake': { ur: 'Eagle sun raha hai — "Eagle" bolein', en: 'Eagle is listening — say "Eagle"' },
